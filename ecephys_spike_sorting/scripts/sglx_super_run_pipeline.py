...
npx_directory = r'Z:\pipeline_test_out\super_out'
...
run_specs = [									
						['240411_QB_2_ex', '0', '0,0', '10:13', ['cortex','thalamus','thalamus','cortex'] ]
]
...
catGT_dest = r'Z:\pipeline_test_out\super_out'
...
toStream_sync_params = 'imec10' # should be ni, imec<probe index>. or obx<obx index>
...
json_directory = r'Z:\pipeline_test_out\super_out\json_files'
...
for spec in run_specs:
    ...
    for i, prb in enumerate(prb_list):
        ...
        if run_CatGT:
            ...
            input_data_directory = os.path.join(catGT_dest, run_folder, prb_folder)
